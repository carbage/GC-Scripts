	...
	public void execute() {
		if (Game.isLoggedIn() & !isBusy) {
			...
			case 0:
				...
				Widgets.get(Main.TAB_AREA_PARENT, Main.TAB_AREA_INVENTORY_TAB)
						.click(true);
				break;
			...
			case 1:
				...
				if (players.length >= 1) {
					Player player = players[Random.nextInt(0,
							players.length - 1)];
					player.click(false);
					Time.sleep(Random.nextInt(75, 250));
					Mouse.move(Random.nextInt(550, 735),
							Random.nextInt(205, 450));
				}
				break;
